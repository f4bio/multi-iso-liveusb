...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 4.9.2 20150304 (prerelease)'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.2/include'
